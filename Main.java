...
class Main {
  public static void main(String[] args) throws Exception {
    ...
    if(!splited[0].equals("Create_parking_lot")){        //edge case: If first input is not for create parking
      System.out.println("Parking Lot need to be created first");
      System.exit(0);
    }
    if(Integer.parseInt(splited[1])>1000){               //edge case: If parking slots are greater than 1000
      System.out.println("MAximum parking slots can be created are 1000");
      System.exit(0);
    }
    ...
    while (sc.hasNextLine()){
      ...
      switch(splited[0]){
        ...
        case "Park":
          ...
          else if(Integer.parseInt(splited[3])<18){
