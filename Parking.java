...
public class Parking implements ParkingService{
  ...
  public void getSlotByRegNum(String registration_number){
    if(reg_slot_map.containsKey(registration_number)){        
    int allocated_slot=reg_slot_map.get(registration_number);
    System.out.println(allocated_slot);
    
  }
    else{
      System.out.println("No car of registration no "+registration_number+" found");
    }
    } 

  public void getRegNumbersByAge(int age){            
    if(age_reg_map.containsKey(age)){
    ...
    System.out.println(list.get(len-1));  
      ...
      System.out.println("No driver of age "+age+" found");
    }
    }
