...
Car - Entity class having car registration_number and driver_age as data members.
ParkingService- An interface of Parking service containing all methods declaration.
Parking- Implements ParkingService class and provides description for the methods. This class is used for handling all the commands implementation.
Main- Input commands are executed through this file.